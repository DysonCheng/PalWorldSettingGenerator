        function generateSettings() {
            ...
            var playerStomachDecreaseRate = document.getElementById('playerStomachDecreaseRate').value;
            var playerStaminaDecreaseRate = document.getElementById('playerStaminaDecreaseRate').value;
            ...
            var palStomachDecreaseRate = document.getElementById('palStomachDecreaseRate').value;
            var palStaminaDecreaseRate = document.getElementById('palStaminaDecreaseRate').value;
