  ...
  "locales": {
    "zh-TW": {
      ...
      "storage": {
        ...
        "compareDescription": "選擇兩個已儲存的備份，快速比較哪些設定值不同。",
    ...
    "en-US": {
      ...
      "storage": {
        ...
        "compareDescription": "Choose two saved backups to quickly compare which setting values differ.",
    ...
    "zh-CN": {
      ...
      "storage": {
        ...
        "compareDescription": "选择两个已保存的备份，快速比较哪些设置值不同。",
    ...
    "ja-JP": {
      ...
      "storage": {
        ...
        "compareDescription": "保存済みバックアップを2つ選び、どの設定値が異なるかすばやく比較します。",
    ...
    "ko-KR": {
      ...
      "storage": {
        ...
        "compareDescription": "저장된 백업 두 개를 선택해 어떤 설정값이 다른지 빠르게 비교합니다.",
    ...
    "es-ES": {
      ...
      "storage": {
        ...
        "compareDescription": "Elige dos copias guardadas para comparar rápidamente qué valores de ajuste cambian.",
    ...
    "fr-FR": {
      ...
      "storage": {
        ...
        "compareDescription": "Choisissez deux sauvegardes pour comparer rapidement les valeurs de réglage différentes.",
    ...
    "de-DE": {
      ...
      "storage": {
        ...
        "compareDescription": "Wähle zwei gespeicherte Backups, um schnell zu sehen, welche Einstellungswerte abweichen.",
    ...
    "pt-BR": {
      ...
      "storage": {
        ...
        "compareDescription": "Selecione dois backups salvos para comparar rapidamente quais valores de configuração mudaram.",
    ...
    "ru-RU": {
      ...
      "storage": {
        ...
        "compareDescription": "Выберите два сохранённых бэкапа, чтобы быстро сравнить отличающиеся значения настроек.",
